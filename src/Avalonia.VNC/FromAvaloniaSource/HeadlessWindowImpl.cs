...
namespace ALTechUK.AvaloniaWindowingVNC.FromAvaloniaSource
{
    internal class HeadlessWindowImpl : IWindowImpl, IPopupImpl, IFramebufferPlatformSurface, IHeadlessWindowEx
    {
        ...
        private class FramebufferProxy : ILockedFramebuffer
        {
            ...
            public nint Address => _fb.Address;
        ...
        void IHeadlessWindowEx.KeyPress(Key key, RawInputModifiers modifiers, PhysicalKey physicalKey, string? keySymbol)
        {
        ...
        void IHeadlessWindowEx.KeyRelease(Key key, RawInputModifiers modifiers, PhysicalKey physicalKey, string? keySymbol)
        {
            Input?.Invoke(new RawKeyEventArgs(
                _keyboard,
                Timestamp,
        ...
        void IHeadlessWindowEx.TextInput(string text)
        {
            if (InputRoot == null)
                return;
        ...
        void IHeadlessWindowEx.MouseDown(Point point, MouseButton button, RawInputModifiers modifiers)
        {
        ...
        void IHeadlessWindowEx.MouseMove(Point point, RawInputModifiers modifiers)
        {
            Input?.Invoke(new RawPointerEventArgs(MouseDevice, Timestamp, InputRoot!,
                RawPointerEventType.Move, point, modifiers));
        }

        void IHeadlessWindowEx.MouseUp(Point point, MouseButton button, RawInputModifiers modifiers)
        {
            Input?.Invoke(new RawPointerEventArgs(MouseDevice, Timestamp, InputRoot!,
                button switch
                {
        ...
        void IHeadlessWindowEx.MouseWheel(Point point, Vector delta, RawInputModifiers modifiers)
        {
            Input?.Invoke(new RawMouseWheelEventArgs(MouseDevice, Timestamp, InputRoot!,
                point, delta, modifiers));
        }
        
        void IHeadlessWindowEx.DragDrop(Point point, RawDragEventType type, IDataObject data, DragDropEffects effects, RawInputModifiers modifiers)
        {
